...
public class Weight extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(ch.philopateer.mibody.R.layout.weight_fragment, container, false);

        weightStatus = (TextView) view.findViewById(ch.philopateer.mibody.R.id.weight_status);
        weightValue = (TextView) view.findViewById(ch.philopateer.mibody.R.id.weight_value);
        weightBtn = (Button) view.findViewById(ch.philopateer.mibody.R.id.weight_btn);
        calibrateBtn = (Button) view.findViewById(ch.philopateer.mibody.R.id.calibrate_btn);
        weightSave = (Button) view.findViewById(ch.philopateer.mibody.R.id.weight_saveBtn);
